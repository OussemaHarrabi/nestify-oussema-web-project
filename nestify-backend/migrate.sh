...
# Nestify Backend Migration Script
# This script will migrate from agency-based to promoter-based system
...
echo "cp database/database.backup.sqlite database/database.sqlite"
